...
class Key(Base):
    ...
    user_id = Column(String, ForeignKey('users.telegram_id'), nullable=False)  # ID пользователя
...
engine = create_engine('sqlite:///my_database.db', echo=True)  # Создаём базу данных SQLite
